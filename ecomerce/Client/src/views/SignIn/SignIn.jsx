    ...
    <div className="flex justify-between text-white">
      <div className="bg-black w-full md:w-2/5">
        ...
        <div className=" h-screen mt-28">
          ...
          <form
            className="flex flex-col align-middle justify-center w-10/12 md:w-3/5 mx-auto"
            onSubmit={handleSubmit}
          >
            <div className="flex flex-col justify-center w-full relative mb-6">
              <label className="absolute w-16 bg-black h-fit bottom-10 left-8 text-cyan-400">
                Email{" "}
              </label>
              <input
            ...
            <p className="text-rose-500 relative bottom-0 md:bottom-2">
              {errors.password}
            </p>
            ...
            <button
              className="bg-cyan-400 py-3 my-6 text-slate-300 "
              type="submit"
            >
              Iniciar
            </button>
