      ...
      {sideBarMenu === true ? (
        ...
        <div className="flex flex-row absolute bottom-2 left-1/2 transform -translate-x-1/2 mb-10 space-x-8 w-full justify-center">
          ...
          <div className="flex flex-row justify-content items-center">
            <div
              onClick={() => addToCart()}
              className="flex justify-center items-center rounded-full bg-teal-400 w-9 h-9 cursor-pointer mx-1"
            >
              <svg
            ...
            <div
              onClick={seeDetails}
              className="flex justify-center items-center rounded-full bg-zinc-200 text-teal-400 w-9 h-9 cursor-pointer mx-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
