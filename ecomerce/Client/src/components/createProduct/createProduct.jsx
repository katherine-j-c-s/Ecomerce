                                            ...
                                            <div>
                                                <ul className="flex flex-row items-center gap-2">
                                                    <li className='relative z-10' onClick={editType}>
                                                        <button type='reset'  className="p-1.5 bg-bluey rounded-full">
                                                            <svg onClick={editType} id={`${t.id},${t.color},${t.talla},${t.cantidad}`}  width="24px" height="24px" viewBox="0 0 24 24" strokeWidth="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000" >
